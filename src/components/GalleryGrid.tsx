      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
        {filteredItems.map(item => (
          <div
            ...
            className="group relative h-64 rounded-2xl overflow-hidden border border-gray-100 shadow-md cursor-pointer hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
          >
            <Image
              src={item.src}
              alt={item.alt}
      ...
      {selectedImage && (
        ...
        >
          ...
          >
            ...
            <button
              onClick={() => setSelectedImage(null)}
              className="absolute top-4 right-4 z-10 bg-navy/80 hover:bg-navy text-white p-2 rounded-full shadow-lg transition-transform hover:rotate-90 duration-300 cursor-pointer"
